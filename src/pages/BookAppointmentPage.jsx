 ...
 * Page component for booking new appointments
 * 
 * Why this component exists:
 * - Separates page-level logic from reusable components
 * - Handles form state management and validation
 * - Manages communication with the appointment service
 * - Provides a clear boundary for appointment booking functionality
 */
